...
func Resolve(path, workspace string, envGet func(string) string, cli map[string]string) Resolution {
	...
	specs := []spec{
		...
		{"codesearch.enabled", nil, func() string { return boolStr(base.CodeSearch.Enabled) }, func() string { return "true" }, false},
		{"codesearch.backend", nil, func() string { return base.CodeSearch.Backend }, func() string { return "lexical" }, false},
		{"codesearch.top_k", nil, func() string { return itoa(base.CodeSearch.TopK) }, func() string { return "6" }, false},
		{"codesearch.max_tokens", nil, func() string { return itoa(base.CodeSearch.MaxTokens) }, func() string { return "800" }, false},
		{"embedding.type", []string{"MINCODE_EMBEDDING_TYPE"}, func() string { return base.Embedding.Type }, func() string { return "" }, false},
		{"embedding.model", []string{"MINCODE_EMBEDDING_MODEL"}, func() string { return base.Embedding.Model }, func() string { return "" }, false},
		{"embedding.base_url", []string{"MINCODE_EMBEDDING_BASE_URL"}, func() string { return base.Embedding.BaseURL }, func() string { return "" }, false},
