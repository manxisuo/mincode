...
const enUS = {
  ...
  "repomap.title": "Repository Map",
  "repomap.refresh": "Refresh",
  "repomap.apply": "Apply",
  "repomap.reset": "Reset",
  "repomap.pathPh": "subdir, e.g. internal/agent",
  "repomap.focusPh": "focus term, e.g. Agent",
  "repomap.files": "files",
  "repomap.symbols": "symbols",
  "repomap.scanned": "scanned",
  "repomap.truncated": "truncated",
  "repomap.disabled": "Repository map is disabled (agent.repo_map: false)",
  "repomap.empty": "No code files found",
  "repomap.colPath": "Path",
  "repomap.colScore": "Score",
  "repomap.colWhy": "Ranking rationale",
  "repomap.colSyms": "Symbols",
  "repomap.defs": "defs",
  "repomap.exported": "exp",
  "repomap.refs": "refs",
  "repomap.pathHit": "path✓",
  "repomap.symHits": "sym✓",
  "repomap.noSyms": "no symbols (path-only)",
  "repomap.showText": "Show raw map text",
  "repomap.hideText": "Hide raw map text",
  "sess.title": "Sessions",
  ...
  "cfg.btn": "Config",
  "cfg.title": "Config resolution",
  "cfg.close": "Close",
  "cfg.note": "Winner is the last layer: default → file → env → cli",
  "cfg.onlyWinner": "Winner only",
  "cfg.empty": "No resolution data",
  "cfg.noFile": "no config file",
...
const zhCN: Record<keyof typeof enUS, string> = {
  ...
  "repomap.apply": "应用",
  "repomap.reset": "重置",
  "repomap.pathPh": "子目录，如 internal/agent",
  "repomap.focusPh": "聚焦词，如 Agent",
  "repomap.files": "文件",
  "repomap.symbols": "符号",
  "repomap.scanned": "扫描",
  "repomap.truncated": "已截断",
  "repomap.disabled": "仓库地图已禁用（agent.repo_map: false）",
  "repomap.empty": "未找到代码文件",
  "repomap.colPath": "路径",
  "repomap.colScore": "得分",
  "repomap.colWhy": "排名依据",
  "repomap.colSyms": "符号",
  ...
  "repomap.exported": "导出",
  "repomap.refs": "引用",
  "repomap.pathHit": "路径命中",
  "repomap.symHits": "符号命中",
  "repomap.noSyms": "无符号（仅路径）",
  "repomap.showText": "显示原始地图文本",
  "repomap.hideText": "隐藏原始地图文本",
  "sess.title": "会话",
  "sess.current": "当前",
  "sess.count": "个会话",
  "sess.refresh": "刷新",
  ...
  "cfg.title": "配置解析链",
  "cfg.close": "关闭",
  "cfg.note": "生效值 = 最后一层：default → file → env → cli",
  "cfg.onlyWinner": "只看生效值",
  "cfg.empty": "暂无解析数据",
  "cfg.noFile": "无配置文件",
  "wire.title": "Wire 请求",
  "wire.close": "关闭",
